...
local function on_player_changed_surface(e)
    ...
    if e.surface_index then
        ...
        storage.surfaces[e.surface_index] = sigd_surface.surface_has_players(surface)
    end
...
local function on_player_left_game(e)
    ...
    storage.surfaces[player.surface.index] = sigd_surface.surface_has_players(player.surface)
end
